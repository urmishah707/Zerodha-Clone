...
function ChargesExplainTab() {
  return (
    <div className="container">
      <div className="row">
        <h2 className="me-5 pe-5 fs-3">Charges explained</h2>
        <div className="col-6 p-4">
          ...
          <h3 className="fs-5">Transaction/Turnover Charges</h3>
          <p>
          ...
          <h3 className="fs-5">Call & trade</h3>
          <p>
            Additional charges of ₹50 per order for orders placed through a
            dealer at Zerodha including auto square off orders.
          </p>
          <h3 className="fs-5">Stamp charges</h3>
          <p>
          ...
          <h3 className="fs-5">NRI brokerage charges</h3>
          <ul>
          ...
          <h3 className="fs-5">Account with debit balance</h3>
          <p>
          ...
          <h3 className="fs-5">Margin Trading Facility (MTF)</h3>
          <ul>
            <li>
        ...
        <div className="col-6 p-4">
          <h3 className="fs-5">GST</h3>
          <p>
            Tax levied by the government on the services rendered. 18% of (
            brokerage + SEBI charges + transaction charges)
          </p>
          <h3 className="fs-5">SEBI Charges</h3>
          <p>
            Charged at ₹10 per crore + GST by Securities and Exchange Board of
            India for regulating the markets.
          </p>
          <h3 className="fs-5">DP (Depository participant) charges</h3>
          <p>
          ...
          <h3 className="fs-5">Pledging charges</h3>
          <p>₹30 + GST per pledge request per ISIN.</p>
          <h3 className="fs-5">AMC (Account maintenance charges)</h3>
          <p>
          ...
          <h3 className="fs-5">Off-market transfer charges</h3>
          <p>₹25 per transaction.</p>
          <h3 className="fs-5">Physical CMR request</h3>
          <p>
            First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST for
            subsequent requests.
          </p>
          <h3 className="fs-5">Payment gateway charges</h3>
          <p>₹9 + GST (Not levied on transfers done via UPI)</p>
          <h3 className="fs-5">Delayed Payment Charges</h3>
          <p>
...
export default ChargesExplainTab;
